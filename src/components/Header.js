  ...
  return (
    <header className="bg-gray-800 text-white p-4 sticky top-0 z-50 ring-2 ring-gray-400 ring-opacity-50">
      <div className="container mx-auto flex justify-between items-center">
        <a onClick={() => handleSetActiveLink('home')} className="text-xl font-bold text-white hover:text-gray-300 cursor-pointer">
          Aditya Patil
        </a>
          ...
          {isMobileMenuOpen && (
            <div className="absolute top-0 right-0 bg-gray-900 w-48 h-screen z-50 flex flex-col items-center py-4">
              ...
              <ul className="flex flex-col items-center space-y-4">
                <li>
                  <a onClick={() => handleSetActiveLink('home')} className={`text-white hover:text-gray-300 cursor-pointer ${activeLink === 'home' ? 'font-bold' : ''}`}>
                    Home
                  </a>
                </li>
                <li>
                  <a onClick={() => handleSetActiveLink('projects')} className={`text-white hover:text-gray-300 cursor-pointer ${activeLink === 'projects' ? 'font-bold' : ''}`}>
                    Projects
                  </a>
                </li>
                <li>
                  <a onClick={() => handleSetActiveLink('skills')} className={`text-white hover:text-gray-300 cursor-pointer ${activeLink === 'skills' ? 'font-bold' : ''}`}>
                    Skills
                  </a>
                </li>
                <li>
                  <a onClick={() => handleSetActiveLink('contact')} className={`text-white hover:text-gray-300 cursor-pointer ${activeLink === 'contact' ? 'font-bold' : ''}`}>
                    Contact
                  </a>
                </li>
              </ul>
